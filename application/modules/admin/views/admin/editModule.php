            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="modules">
                    <div class="row">
                        <div class="col-sm-12 pd-right">
                            <div class="table-header">
                                <div class="table-header-text">Modules Edit</div>
                            </div>
                        </div>
                    </div>
                    <br />
                    ...
                    <div class="row">
                    	...
                    	<form method="post" action="<?php echo base_url('admin')?>/editModule/<?php echo $uID?>" class="form-horizontal" enctype="multipart/form-data">
	                <?php
