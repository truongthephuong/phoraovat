                        ...
                        <div class="row">
                            <div class="col-sm-11 pd-right">
                                ...
                                <div class="table-header">
                                    <div class="table-header-text">Quản Lý Danh Mục Sản Phẩm</div>
                                </div>
                            </div>
                            <div class="col-sm-1">
                                <a href="<?php echo base_url('admin/products').'/addCate'?>" class="btn btn-primary addnew">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span id="elRank<?=$prod->id?>" style="width: 100px;">
                                                    <a href="#" id="<?=$prod->id?>" onclick="comObj.changeRank(<?=$prod->id?>,<?=$prod->rank?>,'categories')" title="change order of news category">
                                                        <?=$prod->rank?>
                                                    </a>
                                                </span>
                                            </td>
                                            <td>
                                            <a href="#" onClick ="javascript:comObj.changeStatus('/admin/products/changeStatus/<?=$prod->id?>/<?=$prod->status?>/cate');">
                                            ...
                                            <td>
                                                ...
                                                <a href="cateEdit/<?=$prod->id?>/<?=$curPage?>" role="button" class="btn" >
