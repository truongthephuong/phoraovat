...
?>
  ...
  <!-- mini logo for sidebar mini 50x50 pixels -->
    <span class="logo-mini"><b>Healthy Spa</b></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b>Admin</b> - Healthy Spa</span>
  </a>
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                      ...
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="/dist/img/halong.jpg" class="user-image" alt="User Image">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                          ...
                          <p>
                            ...
                            <?php
                             $grpNames =  getField($this->session->userdata("userGrp"),'groups_model','name');
