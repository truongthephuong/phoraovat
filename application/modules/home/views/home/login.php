...
<div class="main-block" style="height: 76vh !important">
	<div class="bg-black">
		<div class="inner main-cont">
			<div class="detail">
				<form id="signup" method="post" action="<?php echo base_url('home')?>/login">
					<h3>Đăng Nhập</h3>
					<div class="sep"></div>
					<div class="inputs">
						<label></label>
						...
						<button type="submit" id="submit" name="login" value="login">ĐĂNG NHẬP</button>
					</div>
				</form>
				<div>
					<?php  echo ($this->session->flashdata("memMsg")) ? $this->session->flashdata("memMsg") : '' ;?>
				</div>
			</div>
		</div>
	</div>
