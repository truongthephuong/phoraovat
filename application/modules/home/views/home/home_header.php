<header class="header-block" id="top">
	...
	<?php if($this->session->userdata("memName")) { ?>
		<div class="h-mem">
		<label style="font-size: 0.8em; font-weight: bold">Tài khoản đăng nhập:
			<?php echo $this->session->userdata("memName"); ?> |
			<?php echo anchor($uri = site_url('/home/tin-rao-cua-toi'), $title = 'Tin rao của tôi', 'title="Tin rao của tôi"'); ?> |
			<?php echo anchor($uri = site_url('/home/them-tin-rao'), $title = 'Tạo tin rao mới', 'title="Tạo tin rao mới"'); ?> |
			<a href="<?php echo site_url('/home/myProfile')?>">Thông tin tài khoản</a> | <a href="<?php echo site_url('/home/logout')?>">Thoát</a> |
		</label>
		</div>
		<?php
	} else {
