...
// 25-8-2015
	...
	var dateselect_yearElementsId = "年";
	var dateselect_monthElementsId = "月";
	var dateselect_dayElementsId = "日";
		...
		if(yearObj.value != ""){
			...
			for(i=1;i<dayObj.length + 1;i++){
				...
				if(dateselect_week == 0){
					dayObj.options[i-1].style.backgroundColor = "#fee";
					dayObj.options[i-1].style.color = "#c00";
				}
				else if(dateselect_week == 6){
					dayObj.options[i-1].style.backgroundColor = "#eef";
					dayObj.options[i-1].style.color = "#00c";
				}
				else {
					dayObj.options[i-1].style.backgroundColor = "#fff";
					dayObj.options[i-1].style.color = "#000";
				}
	...
	for(i=1;i<dateselect_bissextile(dateselect_year,dateselect_month+1)+1;i++){
		...
		if(dateselect_week == 0){
			dateselect_font_style = ' style="color: #c00;background-color: #fee;"';
		}
		else if(dateselect_week == 6){
			dateselect_font_style = ' style="color: #00c;background-color: #eef;"';
		}
		else {
